...
const organisation: Member[] = [
  { name: "Dr Salifou NIKIEMA", role: "Président du Comité d'Organisation", detail: "Coordinateur principal — Responsable de la supervision générale de l'organisation du séminaire" },
